...
public class Explosion : MonoBehaviour, IHitter
{
    ...
    private void Start()
    {
        //Collider[] colliders = Physics.OverlapSphere(transform.position, range, affectedLayerMask);
        ...
        //        if(Physics.Linecast(transform.position, c.transform.position,out RaycastHit hit, occludingLayerMask))
        //        {
